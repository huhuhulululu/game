...
export const ITEMS: Record<string, ItemDef> = {
  ...
  fish: { id: "fish", name: "河鱼", kind: "food", rarity: "common", hue: "#8aa4b5", desc: "还在亮。", cook: "both" },
  rare_fish: { id: "rare_fish", name: "银鳞", kind: "food", rarity: "rare", hue: "#d5e6ef", desc: "只有两个人都安静时才肯上钩。", cook: "both" },
