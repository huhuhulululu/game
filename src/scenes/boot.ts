...
export function mountBoot(root: HTMLElement, ctx: GameContext): () => void {
  ...
  scene.innerHTML = `
    <div class="boot-valley" aria-hidden="true">
      <img class="boot-grass" src="/art/tex-grass.png?v=look9" alt="" />
      <img class="boot-tree l" src="/art/prop-tree.png?v=look9" alt="" />
      <img class="boot-tree r" src="/art/prop-tree-wide.png?v=look9" alt="" />
      <img class="boot-cabin" src="/art/prop-cabin.png?v=look9" alt="" />
    </div>
