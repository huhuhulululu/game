...
> **并肩山谷 pin:** this repo uses **Godot 4.4.1 / GDScript**. Do not treat the upstream 4.6 snapshot below as the project engine. Next run: `/setup-engine godot 4.4` to refresh this file. `project.godot` features string stays `"4.3"` (tests lock it).

| Field | Value |
|-------|-------|
| **Engine Version** | Godot 4.6 (upstream CCGS snapshot — project pin is 4.4.1) |
