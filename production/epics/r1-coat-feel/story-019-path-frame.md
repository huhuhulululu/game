...
- [ ] Valley camera follows the coat into a path frame; they sit on the painted path, not a mural stamp
- [ ] BODY stays 240; same idle face; same walk / sit sheets
- [ ] No new art; title couple not pasted; `bed-valley.png` not replaced; no hung props
- [ ] If framing crops the painting into a mess, revert and say so
- [ ] Stickers off; no 魂; no look names in `src/`; no HUD chrome
- [ ] Play-path + test locks; 018 Complete; fireside 019 parked; two-phone Blocked
